...
angular.module("wizard.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("wizard.html",
    ...
    "    </ul>\n" +
    "    <hr>\n" +
    "    <div class=\"steps steps-div\" ng-transclude></div>\n" +
    "    <hr>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module('mgo-angular-wizard').directive('wizard', function() {
    return {
        ...
        controller: ['$scope', '$element', '$log', 'WizardHandler', function($scope, $element, $log, WizardHandler) {
            ...
            $scope.totalStepsNumber = function() {
                //retreive total steps number
                var cnt = 0;
                _.each($scope.steps, function (step) {
                    cnt++;
                });
            ...
            //Access to total steps number from outside
            this.totalStepsNumber = function(){
                return $scope.totalStepsNumber();
            };
